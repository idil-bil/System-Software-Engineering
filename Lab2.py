...
class Rational:
    ...
    def add(self, secondRational):
        ...
        """     
        n = self.numerator * secondRational.denominator + self.denominator * secondRational.numerator
        d = self.denominator * secondRational.denominator
        return Rational(n, d)
    ...
    def multiply(self, secondRational):
        """multiplies 'this' rational to secondRational
           returns the result as a rational number (type Rational)
        """ 
        n = self.numerator * secondRational.numerator
        d = self.denominator * secondRational.denominator
        return Rational(n, d)
    ...
    def divide(self, secondRational):
        """divides 'this' rational by secondRational
           returns the result as a rational number (type Rational)
        """ 
        if self.denominator == 0 or secondRational.denominator == 0:        #checks if the denominators are 0 for the division
            return(Rational(0,0))                                           #return NaN if yes
        else:
            n = self.numerator * secondRational.denominator
            d = self.denominator * secondRational.numerator
            return Rational(n, d)
    ...
    def toString(self):
        ...
        """ 
        if type(self.numerator) != int or  type(self.denominator) != int:   #checks if the value entered is a valid integer
            return "NaN"
        elif self.denominator == 0:                                         #checks for 0 in the denominator
            return "NaN" 
        elif self.denominator == 1 or self.numerator == 0:                  #checks if the result is an integer
            return self.numerator                                           #only prints the numerator if yes                                        
        else:
            return str(self.numerator)+ "/" + str(self.denominator)         #result is in fractions in lowest form
